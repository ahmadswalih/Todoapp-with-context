<h1 align="center">Welcome to Context Todo Application 👋</h1>
<p>
...
Contributions, issues and feature requests are welcome!<br />Feel free to check [issues page]([Todoapp-with-context/issues](https://github.com/ahmadswalih/Todoapp-with-context/issues)). You can also take a look at the [contributing guide]([CONTRIBUTING.md](https://github.com/ahmadswalih/Todoapp-with-context/blob/master/CONTRIBUTING.md)).
